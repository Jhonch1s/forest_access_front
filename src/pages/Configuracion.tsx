  ...
  return (
    <div className="config-page">
      ...
      <section className="config-general-section">
        <h3 className="config-general-title">Información General</h3>
        <div className="config-general-card">
          ...
          <div className="config-general-item">
            ...
            <span className="config-general-value">v1.0.0</span>
          </div>
          ...
          <div className="config-general-item">
            ...
            <span className="config-general-value">Desarrollo</span>
          </div>
          ...
          <div className="config-general-item">
            ...
            <span className="config-general-value">21.345.678-9</span>
          </div>
        </div>
      </section>
    </div>
